...
walkRight = [pygame.image.load('tramp/right_1.png'),
             pygame.image.load(
                 'tramp/right_2.png'), pygame.image.load('tramp/right_3.png'),
             pygame.image.load(
                 'tramp/right_4.png'), pygame.image.load('tramp/right_5.png'),
             pygame.image.load('tramp/right_6.png')]

walkLeft = [pygame.image.load('tramp/left_1.png'),
            pygame.image.load(
                'tramp/left_1.png'), pygame.image.load('tramp/left_1.png'),
            pygame.image.load(
                'tramp/left_1.png'), pygame.image.load('tramp/left_1.png'),
